...
Mass=np.loadtxt('o4sub_NSBH_mass.dat')
Source=np.genfromtxt('o4sub_NSBH_source.dat', dtype=str)
#Mass=np.loadtxt('o4sub_BBH_mass.dat')
#Source=np.genfromtxt('o4sub_BBH_source.dat', dtype=str)

M=1000 #how many good skymaps you want out of this,
...
injectioninfofilename='lhnsbh_injectioninfo.dat'
goodinjection_foldername='o4sub_lh_nsbh'
...
while good_runs < M:
    gpsstart=1238112018
    interval=np.random.uniform(86400,31536000) #from a day to 1 years
    file_number=1
